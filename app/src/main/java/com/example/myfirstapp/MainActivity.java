...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskId=getTaskId();
        System.out.println("MainActivity Create. Task Id: "+taskId);
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        System.out.println("MainActivity onNewIntent. Task Id: "+taskId);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        System.out.println("MainActivity Destroy. Task Id: "+taskId);
    }

    @Override
    protected void onStop() {
        super.onStop();
        System.out.println("MainActivity Stop. Task Id: "+taskId);
    }
}